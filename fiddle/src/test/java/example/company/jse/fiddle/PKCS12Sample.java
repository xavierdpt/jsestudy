...
public class PKCS12Sample {
	...
	public static byte[] privateKeyEncryptionSalt = Common.bytes("8FD2439C4F78EB6612D94F642C7B75FBBF5FF371");
	private static int privateKeyEncryptionIterationCount = 50000;
	public static byte[] encryptedPrivateKey = Common.bytes(
	...
	public static byte[] certificateEncryptionSalt = Common.bytes("1B9DCA53442A0222F5DA254DBBC62C7C6FD2E60E");
	private static int certificateEncryptionIterationCount = 50000;
	...
	public PKCS12Sample() throws NoSuchAlgorithmException, CertificateException, KeyStoreException, IOException,
	...
	public static AsnSequence getSampleSubDataContent() {
		return Asn.seq(
	...
	public static AsnSequence getPrivateKeyEncryptionParameters() {
		return Asn.seq(Asn.os(privateKeyEncryptionSalt), Asn.integer(privateKeyEncryptionIterationCount));
	}

	public static AsnSequence getSampleShroudedContentAsn() {

		return Asn.seq(

				Asn.seq(Asn.oid(OIDS.PBE_WITH_SHA_AND_3_KEY_TRIPLE_DES_CBC), getPrivateKeyEncryptionParameters()),

				Asn.os(encryptedPrivateKey)
